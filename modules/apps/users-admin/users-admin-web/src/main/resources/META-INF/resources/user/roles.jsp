...
<clay:sheet-section>
	...
	>
		...
		>
			...
			<liferay-ui:search-container-column-text>
				<c:if test="<%= !portletName.equals(myAccountPortletId) && !RoleMembershipPolicyUtil.isRoleRequired(selUser.getUserId(), role.getRoleId()) && !(role.getName().equals(RoleConstants.ADMINISTRATOR) && userDisplayContext.isLastAdmin()) %>">
